...
export const LEVELS: Level[] = [
  {
    min: 0,
    title: 'Начало пути',
    description: 'Первые шаги в изучении языка. Каждое новое слово — маленькая победа.',
  },
  {
    min: 100,
    title: 'Первые 100 слов',
    description: 'Базовые слова и выражения: приветствия, числа, простые глаголы.',
  },
  {
    min: 300,
    title: 'Базовые ситуации',
    description: 'Достаточно слов для простых ситуаций: аэропорт, кафе, отель.',
  },
  {
    min: 500,
    title: 'A1 — Начальный',
    description: '500 слов — стандартный A1 по CEFR. Представиться, спросить дорогу, заказать еду.',
  },
  {
    min: 750,
    title: 'Уверенный A1',
    description: 'Комфортно в магазине, банке, на ресепшене. Простые объявления — без словаря.',
  },
  {
    min: 1000,
    title: 'A2 — Элементарный',
    description: '1000 слов — уровень A2. Разговоры о семье, работе, повседневной жизни.',
  },
  {
    min: 1400,
    title: 'Уверенный A2',
    description: 'Адаптированные тексты, переписка, простые видео с субтитрами.',
  },
  {
    min: 2000,
    title: 'B1 — Пороговый',
    description: '2000 слов — B1 по CEFR. Большинство бытовых ситуаций, суть разговоров на знакомые темы.',
  },
  {
    min: 2500,
    title: 'Средний B1',
    description: 'Подкасты, YouTube, письма — без переводчика. Поддерживаете разговор.',
  },
  {
    min: 3000,
    title: 'Уверенный B1',
    description: 'Весь словарный запас приложения. Сериалы с субтитрами, несложные тексты в оригинале.',
  },
];
